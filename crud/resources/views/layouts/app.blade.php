...
<head>
    ...
    <title>{{ config('app.name', 'translation.title') }}</title>
    ...
    @if(app()->getLocale() == 'en')
        <link rel="stylesheet" href="{{ asset('css/ltr-app.css') }}css/ltr-app.css">
    @else
        <link rel="stylesheet" href="{{ asset('css/rtl-app.css') }}css/rtl-app.css">
    @endif
